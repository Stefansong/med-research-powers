...
#### 7. Class Imbalance Handling（类别不平衡处理）
...
#### 8. Model Interpretability / Explainability（模型可解释性）
...
- 报告要求：
  - 至少 3-5 例典型案例的可解释性可视化
  - 包含 typical case, best case, worst case
  - 如有条件，邀请临床医生评估可解释性输出的临床可理解性
