...
med-research-powers/
|-- .claude-plugin/
|   +-- plugin.json                    # 插件元数据 (v6.1.0, 24 个命令)
|-- hooks/
...
|       |-- journal-templates.yaml     # 68 个期刊格式模板
...
| 领域 | 研究类型 |
|---|---|
| **临床** | RCT、队列、病例对照、横断面、诊断准确性 |
| **AI/ML** | 医学影像 AI、手术视频 AI、LLM/VLM 评估、预测模型、临床 NLP、可穿戴/传感器 AI |
| **基础科学** | 细胞生物学、动物模型、分子生物学、组织病理学、Western blot、qPCR |
| **证据综合** | 叙述性综述、系统综述、Meta 分析、范围综述、微型综述 |
| **组学** | 代谢组学、蛋白质组学、基因组学、多组学整合 |
| **器械** | 智能器械、可穿戴设备、人因工程、传感器系统、IDEAL 框架分期 |
| **证据综合** | 系统综述、Meta 分析、网状 Meta 分析、范围综述、叙述性综述、临床指南 |
